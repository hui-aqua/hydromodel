...
In order to use this module, we recommend ``import net2netwake as wake`` in the beginning of your code.
...
class net2net:
    ...
    .. note:: Can only apply to a single fish cage or two net panel.
    """
